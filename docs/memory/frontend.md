...
**Decision**: the UI review of 2026-09-13 (`docs/UI-REVIEW.md`, 32 numbered findings S/H/M/C/T/A/P with P0/P1/P2 tiers, mockups in the "Winnow UI Review" artifact) is a **proposal** — nothing in it shipped with the review. It is nonetheless the reference for any UI work from now on: cite its identifiers in commits (`H2`, `C1`…), and do not add a sixth instance of anything it counts as drift.
