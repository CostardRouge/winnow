...
- 99 knobs across FOUR tiers (68 env · 9 `app_settings` · 6 flags · 16 `localStorage`), 11 managed from a Settings page; three `app_settings` keys have no writer at all → `docs/memory/configuration.md`
