...
- 2026-09-15 — **The UI review's P0 tier shipped and P1 is under way (PR #248).** `PageHeader`, the `.page-tools` band and the session card landed 2026-09-15 (S1, S3, S4, H1–H3 on the cards); what remains of P1: the session page's header and toolbar (H5, and H1–H3 there), the Timeline's chapter dates (H1), colour semantics (H4), control heights (A3/T2), the phone bar (M5), the viewer's info sheet (M4). P2 (five tab families, four chip families, 35 font sizes) is untouched. `docs/UI-REVIEW.md` is the register; the rules in `docs/memory/frontend.md` apply to any new UI meanwhile.
