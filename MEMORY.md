...
- 2026-09-14 — **The UI review's P0 tier shipped (seven commits, PR #248); P1 and P2 are open.** `docs/UI-REVIEW.md` carries 32 numbered findings: P1 is the visible step (one `PageHeader`, the session card and page hierarchy, colour semantics, control heights, the viewer's info sheet), P2 the consolidation of five tab families, four chip families, 35 font sizes. The maintainer picks the order; until then the rules in `docs/memory/frontend.md` ("`docs/UI-REVIEW.md` is the design backlog") apply to any new UI so the drift stops growing.
