...
- 2026-09-15 — **The UI review's P0 tier shipped and P1 is under way (PR #248).** `PageHeader` landed 2026-09-15 (S1/S3's header half, S4); what remains of P1, in the order the maintainer set: the toolbar band (S3's other half), the session card and page hierarchy (H1–H3, H5), colour semantics (H4), control heights (A3/T2), the phone bar (M5), the viewer's info sheet (M4). P2 (five tab families, four chip families, 35 font sizes) is untouched. `docs/UI-REVIEW.md` is the register; the rules in `docs/memory/frontend.md` apply to any new UI meanwhile.
