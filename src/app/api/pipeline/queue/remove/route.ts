...
// scan/analyze/ml queue. Used by the Pipeline triage pages to pull a stuck or
...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!parsed.success)
      return badRequest("name (scan|analyze|ml) and jobId required", parsed.error.issues);
